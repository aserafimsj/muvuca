...
| `audita-telas.js` | Abre as três telas em 375, 768 e 1150px e **reprova** se houver rolagem horizontal, elemento passando da borda ou alvo de toque menor que 32px. Reprova em vez de só relatar, porque regressão de responsividade acontece justamente na próxima alteração de CSS. |
